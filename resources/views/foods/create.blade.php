...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                <!-- Zurück Button, der wieder zu der Hauptseite "Foods" geführt wird -->
            </div>
        </div>
    </div>
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            ...
            <!-- hier kommt eine Fehlermeldung, sobald z.B auf den Button geclickt wird, ohne das etwas in de Felder eingegeben wurde-->
            <ul>
    ...
    <form action="{{ route('foods.store') }}" method="POST">
        <!-- Die Store-Funktion wird hier aufgeruft und per POST Methode wird der Eintrag in der Datenbank abgelegt-->
        @csrf
